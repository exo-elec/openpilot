...
> **EOP Notice:** EOP is **Tesla-only** via `system/socketd/vehicle/`. The upstream multi-brand car porting tools and tests in this directory are preserved for reference but do not apply to EOP.
