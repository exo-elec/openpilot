...
# EOP FORK NOTE: This file was originally a symlink to
# opendbc_repo/opendbc/car/car.capnp. EOP maintains a standalone copy
# with additions (e.g. speedLimit in CarState). Upstream opendbc changes
# must be manually ported. See cereal/custom.capnp for EOP-only structs.
...
struct CarState {
  ...
  # fields @51-@60 match opendbc car.capnp @ 4b203ff5d (wire compatibility;
  # EOP code from that generation references them)
  espActive @51 :Bool;
