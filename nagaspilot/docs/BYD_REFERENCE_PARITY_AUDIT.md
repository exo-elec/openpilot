...
| Reference POC controls | Not yet parity (unchanged) | LKAS-button latch, fixed-acceleration probe, rocker behavior, `gearStep`, and diagnostic bring-up controls are not ported. Staged differences, not rejected features. |
