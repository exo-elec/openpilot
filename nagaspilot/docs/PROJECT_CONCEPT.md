...
- NGP10 proves DLAT, DLON, VTSC, MTSC, ALCC, LCA, speed policy, SOC, GridD,
  and overlay contracts with unit tests and recorded routes. Features that
...
GridD, MonoD, SOC, and side/left/right/rear overlays may exist as portable,
capability-gated application modules; comma 3 must fall back to its two road
