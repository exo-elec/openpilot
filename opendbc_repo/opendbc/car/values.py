...
from opendbc.car.gateway.values import CAR as GATEWAY
...
Platform = BODY | CHRYSLER | FORD | GATEWAY | GM | HONDA | HYUNDAI | MAZDA | MOCK | NISSAN | PSA | RIVIAN | SUBARU | TOYOTA | VOLKSWAGEN
