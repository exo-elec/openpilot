...
from openpilot.selfdrive.ui.state import Snapshot, UIStatus
from openpilot.selfdrive.ui.views.home import OffroadHome
...
from openpilot.selfdrive.ui.views.sidebar import Sidebar
...
class MainWindow(QWidget):
  ...
  def _build_onboarding(self) -> QWidget:
    from openpilot.selfdrive.ui.views.onboarding import OnboardingView
