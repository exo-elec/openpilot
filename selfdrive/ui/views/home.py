...
from openpilot.selfdrive.ui.qt import Qt, QTimer, QtWidgets, QWidget, Signal
...
#
# Repo-root relative, so the parents[] index below must reach the repo root
# and not selfdrive/ -- getting that wrong doubles the leading segment and
# the catalogue silently reads as empty, which looks exactly like "no alerts
# are raised". test_alert_catalogue_actually_resolves guards it.
