...
from openpilot.selfdrive.ui.settings.descriptor import (
  PAGES,
  Kind,
  all_controls,
  declared_keys,
)
from openpilot.selfdrive.ui.settings.exclusions import (
  TRIAGED,
  UNTRIAGED,
  excluded_keys,
)
from openpilot.selfdrive.ui.settings.params_registry import (
  all_params,
  eop_keys,
  eop_params,
)
