...
from openpilot.selfdrive.ui.components.border_overlay import (
  BorderOverlay,
  Mode,
  Side,
)
from openpilot.selfdrive.ui.components.camera_overlay import (
  IDLE_BORDER_PX,
  WARN_BORDER_PX,
  Camera,
  CameraOverlayStack,
...
from openpilot.selfdrive.ui.qt import QApplication, QWidget
...
class TestFrameConversion:
  def test_bgr_is_byte_swapped_not_reinterpreted(self):
    ...
    import numpy as np
    from openpilot.selfdrive.ui.components.camera_view import bgr_to_rgb
