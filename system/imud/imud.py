...
class LSM6DS3(ImuSensor):
    ...
    I2C registers:
      WHO_AM_I      = 0x0F (should read 0x69)
      CTRL1_XL      = 0x10 (accel config)
      CTRL2_G       = 0x11 (gyro config)
      CTRL3_C       = 0x12 (control)
      OUTX_L_G      = 0x22 (gyro X low)
      OUTX_L_XL     = 0x28 (accel X low)
      OUT_TEMP_L    = 0x20 (temp low)
    """
    ...
    DEFAULT_CTRL1_XL = 0x40  # 104 Hz, ±2g
    DEFAULT_CTRL2_G = 0x40   # 104 Hz, ±250 dps
    DEFAULT_CTRL3_C = 0x04   # IF_INC = 1 (auto-increment address)
    
    # Scale factors
    ACCEL_SCALE_2G = 0.061   # mg/LSB
    GYRO_SCALE_250DPS = 8.75  # mdps/LSB
    TEMP_SCALE = 256.0       # LSB/°C
    ...
    def init(self) -> bool:
        ...
        try:
            ...
            if chip_id != 0x69:
                cloudlog.warning(f"imud: Unexpected WHO_AM_I = 0x{chip_id:02X}, expected 0x69")
