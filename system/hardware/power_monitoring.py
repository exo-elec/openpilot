...
class PowerMonitoring:
  def __init__(self):
    ...
    self.np_device_auto_shutdown_min = int(self.params.get("np_device_auto_shutdown") or -5)
    self.np_device_auto_shutdown = self.np_device_auto_shutdown_min >= 0
  ...
  def should_shutdown(self, ignition: bool, in_car: bool, offroad_timestamp: float | None, started_seen: bool):
    ...
    if started_seen and self.np_device_auto_shutdown and offroad_time > (self.np_device_auto_shutdown_min * 60):
      return True
