...
| `radar4d` | `selfdrive/controls/radar4d.py` → `gridd.py` | `Radar4DD` | ESP32_RADAR `dev/v2` (CAL77S244) WiFi 4D point cloud (02M only) → vehicle-frame points → costmap; not a corner safety input (`docs/eop/04_Integration/ESP32_RADAR_CORNER.md`) | 20 Hz |
